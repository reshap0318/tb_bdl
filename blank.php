...
<!-- Mirrored from colorlib.com//polygon/adminty/default/sample-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Nov 2018 03:08:37 GMT -->
...
<head>
    ...
    <!-- Required Fremwork -->
    <link rel="stylesheet" type="text/css" href="editor/bower_components/bootstrap/css/bootstrap.min.css">
    <!-- themify-icons line icon -->
    <link rel="stylesheet" type="text/css" href="editor/assets/icon/themify-icons/themify-icons.css">
    <!-- ico font -->
    <link rel="stylesheet" type="text/css" href="editor/assets/icon/icofont/css/icofont.css">
    <!-- feather Awesome -->
    <link rel="stylesheet" type="text/css" href="editor/assets/icon/feather/css/feather.css">
    <!-- Style.css -->
    <link rel="stylesheet" type="text/css" href="editor/assets/css/style.css">
    <link rel="stylesheet" type="text/css" href="editor/assets/css/jquery.mCustomScrollbar.css">
        ...
        <nav class="navbar header-navbar pcoded-header">
            <div class="navbar-wrapper">
                ...
                <div class="navbar-logo">
                    ...
                    <a href="index.html">
                        <img class="img-fluid" src="editor/assets/images/logo.png" alt="Theme-Logo" />
                    </a>
                ...
                <div class="navbar-container container-fluid">
                    ...
                    <ul class="nav-right">
                        <li class="header-notification">
                            <div class="dropdown-primary dropdown">
                                ...
                                <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                    ...
                                    <li>
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="editor/assets/images/avatar-4.jpg" alt="Generic placeholder image">
                                    ...
                                    <li>
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="editor/assets/images/avatar-3.jpg" alt="Generic placeholder image">
                                            <div class="media-body">
                        ...
                        <li class="user-profile header-notification">
                            <div class="dropdown-primary dropdown">
                                <div class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="editor/assets/images/avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
                                    <span>John Doe</span>
                        ...
                        <div class="main-friend-list">
                            <div class="media userlist-box" data-id="1" data-status="online" data-username="Josephin Doe" data-toggle="tooltip" data-placement="left" title="Josephin Doe">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius img-radius" src="editor/assets/images/avatar-3.jpg" alt="Generic placeholder image ">
                            ...
                            <div class="media userlist-box" data-id="2" data-status="online" data-username="Lary Doe" data-toggle="tooltip" data-placement="left" title="Lary Doe">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="editor/assets/images/avatar-2.jpg" alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media userlist-box" data-id="3" data-status="online" data-username="Alice" data-toggle="tooltip" data-placement="left" title="Alice">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="editor/assets/images/avatar-4.jpg" alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media userlist-box" data-id="4" data-status="online" data-username="Alia" data-toggle="tooltip" data-placement="left" title="Alia">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="editor/assets/images/avatar-3.jpg" alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
        ...
        <div class="showChat_inner">
            ...
            <div class="media chat-messages">
                <a class="media-left photo-table" href="#!">
                    <img class="media-object img-radius img-radius m-t-5" src="editor/assets/images/avatar-3.jpg" alt="Generic placeholder image">
                </a>
            ...
            <div class="media chat-messages">
                ...
                <div class="media-right photo-table">
                    <a href="#!">
                        <img class="media-object img-radius img-radius m-t-5" src="editor/assets/images/avatar-4.jpg" alt="Generic placeholder image">
                    </a>
                </div>
            </div>
...
<!-- Required Jquery -->
<script type="text/javascript" src="editor/bower_components/jquery/js/jquery.min.js"></script>
<script type="text/javascript" src="editor/bower_components/jquery-ui/js/jquery-ui.min.js"></script>
<script type="text/javascript" src="editor/bower_components/popper.js/js/popper.min.js"></script>
<script type="text/javascript" src="editor/bower_components/bootstrap/js/bootstrap.min.js"></script>
<!-- jquery slimscroll js -->
<script type="text/javascript" src="editor/bower_components/jquery-slimscroll/js/jquery.slimscroll.js"></script>
<!-- modernizr js -->
<script type="text/javascript" src="editor/bower_components/modernizr/js/modernizr.js"></script>
<script type="text/javascript" src="editor/bower_components/modernizr/js/css-scrollbars.js"></script>

<!-- i18next.min.js -->
<script type="text/javascript" src="editor/bower_components/i18next/js/i18next.min.js"></script>
<script type="text/javascript" src="editor/bower_components/i18next-xhr-backend/js/i18nextXHRBackend.min.js"></script>
<script type="text/javascript" src="editor/bower_components/i18next-browser-languagedetector/js/i18nextBrowserLanguageDetector.min.js"></script>
<script type="text/javascript" src="editor/bower_components/jquery-i18next/js/jquery-i18next.min.js"></script>
<script src="editor/assets/js/pcoded.min.js"></script>
<script src="editor/assets/js/vartical-layout.min.js"></script>
<script src="editor/assets/js/jquery.mCustomScrollbar.concat.min.js"></script>
    <!-- Custom js -->
    <script type="text/javascript" src="editor/assets/js/script.js"></script>
