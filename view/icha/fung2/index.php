...
<?php startblock('title') ?> Icha Fungsional : 2 <?php endblock() ?>
...
<div class="card">
    ...
    <div class="card-block user-desc">
        <div class="view-desc">
            <p>Fungsional Ini Berfungsi untuk mengetahui Lokasi-lokasi kapal dari pemilik yang berlayar beserta  kapal, jenis kapal,  abk, dari usaha perikanan tersebut, jenis dari usaha perikanan, transaksi beserta detail transaksi dan juga produksi berdasarkan nama pemilik.<br>
  ...
  <script type="text/javascript">
    function format(d) {
          ...
          return '<table class="table table-striped table-bordered nowrap">' +
            ...
            '<tr>'+
            '<td>Aksi</td>' +
            '<td><a href="javascript:void(0)" onclick="daerahpelayaran('+d.kode_pelayaran+')" class="btn btn-primary btn-mini waves-effect waves-light"><i class="fa fa-map-pin"></i></a></td>' +
            '<td>  </td>' +
            '<td> </td>' +
            '</tr>' +
            '</table>';
